const template = (email, status, uuid, freeUser) => {
  ...
  if (freeUser && (status === "quoting" || status === "downloaded")) {
    ...
    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
        <td class="status"><strong>Status Process:</strong> <span>${status}</span></td>
        </tr>
      </tbody>
    </table>
    `;
  ...
  <head>
    ...
    <style>
      ...
      .btn-primary table td.status {

        background-color: transparent; 

      }
      .btn-primary table td.status span{
        color: #3498db;
        font-weight: bolder;
        font-style: oblique;
      }
      ...
      @media all {
        ...
        .btn-primary table td.content-block: hover {
          ...
          <div class="content">
            ...
            <div class="footer">
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="https://pangeanic.es/">Pangeanic</a>.
                  </td>
                </tr>
              </table>
            </div>
